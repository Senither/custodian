<x-app-layout>
    ...
    <div class="flex flex-col gap-4 bg-base-100 shadow-lg px-6 py-4 rounded-md">
        <!-- Task Card : Buy groceries : Start -->
        <div class="border-primary/10 bg-primary/5 shadow px-4 py-3 border rounded-md">
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-4">
                    <input type="checkbox" class="checkbox checkbox-lg checked:checkbox-primary" />

                    <div>
                        <h4 class="font-semibold text-lg">Buy groceries</h4>
                ...
                <div class="flex gap-2">
                    ...
                    <button onclick="editTaskModal.showModal()"
        ...
        <!-- Task Card : Buy groceries : End -->

        <!-- Task Card : Build Custodian using new stacks : Start -->
        <div class="border-primary/10 bg-primary/5 shadow px-4 py-3 border rounded-md">
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-4">
                    <input type="checkbox" class="checkbox checkbox-lg checked:checkbox-primary" />
                    ...
                    <div>
                        <h4 class="font-semibold text-lg">Build Custodian using new stacks</h4>
                        <div class="flex gap-3">
                            <span class="py-2 text-secondary-content cursor-pointer badge badge-secondary badge-sm">
                                priority: low
                            </span>
        ...
        <!-- Task Card : Build Custodian using new stacks : End -->

        <!-- Task Card : Finish client project : Start -->
        <div
             class="border-primary/10 bg-primary/5 opacity-45 hover:opacity-80 shadow px-4 py-3 border rounded-md transition-opacity">
            <div class="flex justify-between items-center">
                <div class="flex items-center gap-4">
                    <input type="checkbox" class="checkbox checkbox-lg checked:checkbox-primary"
                           checked="checked" />
                    ...
                    <div>
                        <h4 class="font-semibold text-lg">Finish client project</h4>
                        <div class="flex gap-3">
                            <span class="py-2 text-secondary-content cursor-pointer badge badge-secondary badge-sm">
                                priority: highest
                            </span>
        ...
        <!-- Task Card : Finish client project : End -->
    </div>
